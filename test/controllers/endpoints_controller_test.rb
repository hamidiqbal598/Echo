...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endpoint" do
    assert_difference('Endpoint.count') do
      post endpoints_url, params: { endpoint: { path: @endpoint.path, type: @endpoint.type, verb: @endpoint.verb } }
    end
  ...
  test "should update endpoint" do
    patch endpoint_url(@endpoint), params: { endpoint: { path: @endpoint.path, type: @endpoint.type, verb: @endpoint.verb } }
